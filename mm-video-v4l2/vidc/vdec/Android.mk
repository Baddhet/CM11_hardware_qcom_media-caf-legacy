...
libmm-vdec-inc          += hardware/qcom/media-caf-legacy/mm-core/inc
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += hardware/qcom/display-caf-legacy/libgralloc
libmm-vdec-inc          += frameworks/native/include/media/openmax
libmm-vdec-inc          += frameworks/native/include/media/hardware
libmm-vdec-inc          += $(vdec-inc)
libmm-vdec-inc          += hardware/qcom/display-caf-legacy/libqdutils
libmm-vdec-inc      += hardware/qcom/media-caf-legacy/libc2dcolorconvert
libmm-vdec-inc      += hardware/qcom/display-caf-legacy/libcopybit
libmm-vdec-inc      += frameworks/av/include/media/stagefright
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/qcom/display-caf-legacy/

ifdef TARGET_ENABLE_DEC_META_DATA_MODE
libOmxVdec-def += -DMETA_DATA_MODE_SUPPORTED
libmm-vdec-inc += hardware/qcom/media-caf-legacy/libstagefrighthw
endif
...
libmm-vdec-inc          += hardware/qcom/display-caf-legacy/libhwcomposer
...
mm-vdec-test-inc    := hardware/qcom/media-caf-legacy/mm-core/inc
...
mm-vdec-drv-test-inc    := hardware/qcom/media-caf-legacy/mm-core/inc
